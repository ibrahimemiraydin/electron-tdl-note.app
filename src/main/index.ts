...
import { getAllTasks, addTask, updateTask, trashTask, deleteTaskPermanently, renameTask, getTrashedTasks, restoreTask } from '../database'; // Import database functions
...
ipcMain.handle('restore-task', (_, id) => restoreTask(id));
